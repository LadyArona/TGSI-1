                ...
                <table class="bordered rounded diced striped hovered shadowed narrow table"> 
                    ...
                    <tbody> 
                        <tr data-role="tableRow" data-id="">
                            ...
                            <td>Arquiteturas de ensino a programação para crianças e a integração destas com sistemas Lego e Lego Mindstorms.</td> 
                            <td WIDTH="100">
                        ...
                        <tr data-role="tableRow" data-id=""> 
                            ...
                            <td>Desenvolvimento de jogos, bibliotecas gráficas e motores de jogos em programação funcional</td> 
                            <td WIDTH="100">
                                <button type="button" class="btn mini primary">Visualizar</button>
                            </td> 
                        </tr> 
                        <tr data-role="tableRow" data-id="">
                            ...
                            <td>Aluno Sobrenome Aluno</td> 
                            <td>aluno@ufsm.com.br</td> 
                            <td> Neurociência computacional (modelagem de redes neurais fisiologicamente realistas e / ou modelagem comportamental de processos cognitivos), neuro-imagem, e interfaces cérebro-máquina.</td> 
                            <td WIDTH="100">
                                <button type="button" class="btn mini primary">Visualizar</button>
                            </td>  
                        </tr>                         
