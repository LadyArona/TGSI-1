...
?>
    ...
    <div class="band">
        <div class="container">
            ...
            <form id="formOcorrencia" action="/aluno/alteracao-curricular/trancamentoTotal.html" method="post" enctype="multipart/form-data">
                <div class="row"> 
                    <div class="span12"> <span class="label">Observação</span><br>
                        <div class="">
                ...
                <fieldset class="bordered rounded shadowed margin-bottom"> 
                    <div class="row"> 
                        <div> É possível anexar documentos e enviar para seu orientador. <br> 
                            <strong>Tamanho arquivos:</strong> 10 Mb por arquivo. <br> 
