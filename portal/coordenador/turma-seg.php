<?php
    ...
    $query = mysqli_query($conexao,"SELECT  tur_codigo,tur_ano ,tur_semestre,tur_descricao, tur_data_proposta from turma where tur_ano = '$ano' and tur_semestre = '$semestre'")or die(mysql_error());
        ...
        <div class="container">
            ...
            <form id="insereTurma" action="insere-turma.php" method="post"> <!--envia dados para insere-turma.php ao clicar em Salvar-->  
                ...
                <div class="box shadowed bordered rounded">
                    ...
                    <input id="codigo" name="codigo" class="hidden" type="hidden">
                </div>            
